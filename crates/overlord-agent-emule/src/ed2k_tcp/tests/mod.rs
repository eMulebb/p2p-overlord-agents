...
use super::{
    ...
    OP_AICHFILEHASHANS, OP_AICHFILEHASHREQ, OP_ANSWERSOURCES, OP_ANSWERSOURCES2, OP_CANCELTRANSFER,
    OP_COMPRESSEDPART, OP_EDONKEYPROT, OP_EMULEINFO, OP_EMULEINFOANSWER, OP_EMULEPROT, OP_FILEDESC,
    OP_FILESTATUS, OP_FWCHECKUDPREQ, OP_HASHSETANSWER2, OP_HASHSETREQUEST2, OP_HELLO,
    OP_HELLOANSWER, OP_KAD_FWTCPCHECK_ACK, OP_MULTIPACKET_EXT, OP_MULTIPACKET_EXT2,
    OP_MULTIPACKETANSWER, OP_PACKEDPROT, OP_PORTTEST, OP_PUBLICIP_ANSWER, OP_PUBLICIP_REQ,
    ...
    decode_incoming_obfuscation_header, decode_peer_payload, decode_public_ip_answer_payload,
    ...
    encode_aich_file_hash_request, encode_answer_sources, encode_answer_sources2,
