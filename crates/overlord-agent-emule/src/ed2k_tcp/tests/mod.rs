...
use super::{
    ...
    OP_CHANGE_CLIENT_ID, OP_CHATCAPTCHAREQ, OP_CHATCAPTCHARES, OP_COMPRESSEDPART, OP_EDONKEYPROT,
    ...
    OP_PUBLICIP_REQ, OP_PUBLICKEY, OP_QUEUERANKING, OP_REASKCALLBACKTCP, OP_REQFILENAMEANSWER,
