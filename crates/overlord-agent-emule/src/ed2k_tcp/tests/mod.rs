...
use super::{
    ...
    decode_emule_queue_ranking_payload, decode_file_description_payload, decode_hashset_answer2,
    ...
    decode_shared_files_dir_request_payload, derive_obfuscation_key, download_file_from_peer,
