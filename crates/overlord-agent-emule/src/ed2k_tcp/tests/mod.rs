...
use super::{
    ...
    OP_AICHFILEHASHANS, OP_AICHFILEHASHREQ, OP_ANSWERSOURCES, OP_ANSWERSOURCES2, OP_BUDDYPING,
    OP_BUDDYPONG, OP_CANCELTRANSFER, OP_COMPRESSEDPART, OP_EDONKEYPROT, OP_EMULEINFO,
    OP_EMULEINFOANSWER, OP_EMULEPROT, OP_END_OF_DOWNLOAD, OP_FILEDESC, OP_FILESTATUS,
    OP_FWCHECKUDPREQ, OP_HASHSETANSWER2, OP_HASHSETREQUEST2, OP_HELLO, OP_HELLOANSWER,
    OP_KAD_FWTCPCHECK_ACK, OP_MULTIPACKET_EXT, OP_MULTIPACKET_EXT2, OP_MULTIPACKETANSWER,
    OP_OUTOFPARTREQS, OP_PACKEDPROT, OP_PORTTEST, OP_PUBLICIP_ANSWER, OP_PUBLICIP_REQ,
    OP_PUBLICKEY, OP_QUEUERANKING, OP_REQFILENAMEANSWER, OP_REQUESTFILENAME, OP_REQUESTPARTS,
    OP_REQUESTPARTS_I64, OP_REQUESTSOURCES, OP_REQUESTSOURCES2, OP_SECIDENTSTATE, OP_SENDINGPART,
    OP_SETREQFILEID, OP_SIGNATURE, OP_STARTUPLOADREQ, PeerSourceExchangeRequest,
    PendingCompressedPart, SourceExchangePeer, TAGTYPE_UINT32, begin_secure_ident_probe,
    build_hello_responses, build_upload_part_packets, connect_callback_peer,
    decode_aich_file_hash_answer, decode_answer_sources_payload, decode_compressed_part_fragment,
    decode_file_description_payload, decode_hashset_answer2, decode_hashset_request2,
    decode_hello_profile, decode_incoming_obfuscation_header, decode_peer_payload,
    decode_public_ip_answer_payload, decode_public_key_payload, decode_request_parts_payload,
    decode_secident_state, decode_sending_part_payload, derive_obfuscation_key,
    ...
    encode_aich_file_hash_answer, encode_aich_file_hash_request, encode_answer_sources,
    encode_answer_sources2, encode_compressed_part_fragment, encode_emule_info_answer,
    encode_emule_info_request, encode_hashset_answer2, encode_hashset_request2,
    encode_hello_answer, encode_hello_request, encode_incoming_obfuscation_response,
    encode_multipacket_answer, encode_multipacket_ext2_request, encode_multipacket_request,
    encode_packed_packet, encode_packet, encode_port_test_answer, encode_public_ip_answer,
