...
use super::{
    ...
    OP_HELLOANSWER, OP_MULTIPACKET_EXT2, OP_PACKEDPROT, OP_PUBLICKEY, OP_QUEUERANKING,
    OP_REQFILENAMEANSWER, OP_REQUESTFILENAME, OP_REQUESTPARTS, OP_REQUESTPARTS_I64,
    OP_REQUESTSOURCES, OP_REQUESTSOURCES2, OP_SECIDENTSTATE, OP_SENDINGPART, OP_SIGNATURE,
    ...
    connect_callback_peer, decode_aich_file_hash_answer, decode_compressed_part_fragment,
    decode_hashset_answer2, decode_hashset_request2, decode_incoming_obfuscation_header,
