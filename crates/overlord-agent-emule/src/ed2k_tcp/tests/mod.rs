...
use super::{
    ...
    OP_ANSWERSOURCES2, OP_BUDDYPING, OP_BUDDYPONG, OP_CANCELTRANSFER, OP_CHANGE_CLIENT_ID,
    ...
    OP_HASHSETREQUEST2, OP_HELLO, OP_HELLOANSWER, OP_KAD_FWTCPCHECK_ACK, OP_MULTIPACKET_EXT,
    OP_MULTIPACKET_EXT2, OP_MULTIPACKETANSWER, OP_OUTOFPARTREQS, OP_PACKEDPROT, OP_PORTTEST,
    OP_PREVIEWANSWER, OP_PUBLICIP_ANSWER, OP_PUBLICIP_REQ, OP_PUBLICKEY, OP_QUEUERANKING,
