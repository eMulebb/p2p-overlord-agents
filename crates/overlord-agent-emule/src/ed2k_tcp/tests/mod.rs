...
use super::{
    ...
    OP_HASHSETANSWER2, OP_HASHSETREQUEST2, OP_HELLO, OP_HELLOANSWER, OP_MULTIPACKET_EXT2,
    OP_PACKEDPROT, OP_PUBLICKEY, OP_QUEUERANKING, OP_REQFILENAMEANSWER, OP_REQUESTFILENAME,
    OP_REQUESTPARTS, OP_REQUESTPARTS_I64, OP_REQUESTSOURCES, OP_REQUESTSOURCES2, OP_SECIDENTSTATE,
    OP_SENDINGPART, OP_SIGNATURE, OP_STARTUPLOADREQ, PeerSourceExchangeRequest,
    PendingCompressedPart, TAGTYPE_UINT32, begin_secure_ident_probe, build_hello_responses,
    build_upload_part_packets, connect_callback_peer, decode_compressed_part_fragment,
    ...
    encode_aich_file_hash_request, encode_compressed_part_fragment, encode_emule_info_answer,
