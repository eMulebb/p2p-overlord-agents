...
use super::{
    ...
    OP_CHANGE_CLIENT_ID, OP_CHANGE_SLOT, OP_CHATCAPTCHAREQ, OP_CHATCAPTCHARES, OP_COMPRESSEDPART,
    OP_EDONKEYPROT, OP_EMULEINFO, OP_EMULEINFOANSWER, OP_EMULEPROT, OP_END_OF_DOWNLOAD,
    OP_FILEDESC, OP_FILESTATUS, OP_FWCHECKUDPREQ, OP_HASHSETANSWER2, OP_HASHSETREQUEST2, OP_HELLO,
    OP_HELLOANSWER, OP_KAD_FWTCPCHECK_ACK, OP_MESSAGE, OP_MULTIPACKET_EXT, OP_MULTIPACKET_EXT2,
    OP_MULTIPACKETANSWER, OP_OUTOFPARTREQS, OP_PACKEDPROT, OP_PORTTEST, OP_PREVIEWANSWER,
    OP_PUBLICIP_ANSWER, OP_PUBLICIP_REQ, OP_PUBLICKEY, OP_QUEUERANKING, OP_REASKCALLBACKTCP,
    ...
    decode_compressed_part_fragment, decode_file_description_payload, decode_hashset_answer2,
    decode_hashset_request2, decode_hello_profile, decode_incoming_obfuscation_header,
    ...
    decode_reask_callback_tcp_payload, decode_request_parts_payload, decode_secident_state,
    decode_sending_part_payload, derive_obfuscation_key, download_file_from_peer,
