...
use super::{
    ...
    OP_PACKEDPROT, OP_PORTTEST, OP_PUBLICIP_ANSWER, OP_PUBLICIP_REQ, OP_PUBLICKEY, OP_QUEUERANKING,
    OP_REQFILENAMEANSWER, OP_REQUESTFILENAME, OP_REQUESTPARTS, OP_REQUESTPARTS_I64,
    OP_REQUESTSOURCES, OP_REQUESTSOURCES2, OP_SECIDENTSTATE, OP_SENDINGPART, OP_SETREQFILEID,
    OP_SIGNATURE, OP_STARTUPLOADREQ, PeerSourceExchangeRequest, PendingCompressedPart,
    SourceExchangePeer, TAGTYPE_UINT32, begin_secure_ident_probe, build_hello_responses,
    build_upload_part_packets, connect_callback_peer, decode_aich_file_hash_answer,
    decode_answer_sources_payload, decode_compressed_part_fragment,
