...
use super::{
    ...
    OP_MULTIPACKET_EXT2, OP_MULTIPACKETANSWER, OP_PACKEDPROT, OP_PORTTEST, OP_PUBLICIP_ANSWER,
    OP_PUBLICIP_REQ, OP_PUBLICKEY, OP_QUEUERANKING, OP_REQFILENAMEANSWER, OP_REQUESTFILENAME,
    OP_REQUESTPARTS, OP_REQUESTPARTS_I64, OP_REQUESTSOURCES, OP_REQUESTSOURCES2, OP_SECIDENTSTATE,
    OP_SENDINGPART, OP_SETREQFILEID, OP_SIGNATURE, OP_STARTUPLOADREQ, PeerSourceExchangeRequest,
