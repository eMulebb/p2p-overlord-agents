...
use super::{
    ...
    OP_BUDDYPONG, OP_CANCELTRANSFER, OP_CHANGE_CLIENT_ID, OP_COMPRESSEDPART, OP_EDONKEYPROT,
    OP_EMULEINFO, OP_EMULEINFOANSWER, OP_EMULEPROT, OP_END_OF_DOWNLOAD, OP_FILEDESC, OP_FILESTATUS,
    ...
    decode_aich_file_hash_answer, decode_answer_sources_payload, decode_client_id_change_payload,
    ...
    decode_peer_payload, decode_public_ip_answer_payload, decode_public_key_payload,
