...
use super::{
    ...
    OP_FILEREQANSNOFIL, OP_FILESTATUS, OP_FWCHECKUDPREQ, OP_HASHSETANSWER, OP_HASHSETANSWER2,
    OP_HASHSETREQUEST, OP_HASHSETREQUEST2, OP_HELLO, OP_HELLOANSWER, OP_KAD_FWTCPCHECK_ACK,
    OP_MESSAGE, OP_MULTIPACKET, OP_MULTIPACKET_EXT, OP_MULTIPACKET_EXT2, OP_MULTIPACKETANSWER,
