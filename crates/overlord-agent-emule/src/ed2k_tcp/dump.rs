...
use super::{
    ...
    OP_FILEDESC, OP_FILEREQANSNOFIL, OP_FILESTATUS, OP_FWCHECKUDPREQ, OP_HASHSETANSWER,
    OP_HASHSETANSWER2, OP_HASHSETREQUEST, OP_HASHSETREQUEST2, OP_HELLO, OP_HELLOANSWER,
    OP_MULTIPACKET, OP_MULTIPACKET_EXT, OP_MULTIPACKET_EXT2, OP_MULTIPACKETANSWER,
    OP_MULTIPACKETANSWER_EXT2, OP_PACKEDPROT, OP_PORTTEST, OP_PUBLICIP_ANSWER, OP_PUBLICIP_REQ,
