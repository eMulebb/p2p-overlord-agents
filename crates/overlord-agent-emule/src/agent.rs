...
use overlord_agent_nat::{
    AgentNetworkReport, AgentNetworkingConfig, InterfaceSelectionState, MappingExposure,
    MappingSpec, NatManager, NatManagerBuilder, ResolvedInterfaceBindingReport, TransportProtocol,
