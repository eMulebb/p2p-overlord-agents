...
pub(in crate::ed2k_tcp) use codec::{
    ...
    encode_aich_recovery_failure_answer, encode_empty_shared_files_answer, encode_hashset_request,
...
pub(in crate::ed2k_tcp) use hello::{
    build_hello_responses, decode_hello_profile, encode_emule_info_answer, encode_hello_request,
};
#[cfg(test)]
use hello::{
